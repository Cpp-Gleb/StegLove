...
#include <memory>
#include "../../../../Downloads/practice_cource/l3/DiplomWork/StegLove/dialogrec.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DialogRec_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_DialogRec_t qt_meta_stringdata_DialogRec = {
    {
QT_MOC_LITERAL(0, 9) // "DialogRec"
...
const QMetaObject DialogRec::staticMetaObject = { {
    ...
    qt_meta_stringdata_DialogRec.offsetsAndSize,
    qt_meta_data_DialogRec,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DialogRec_t
